...
export default function InputBox({setTokenValue,setInputError,inputError,tipValue,inObj,outObj,calcStatus }:InputBoxProps) {
  const valueRef = useRef("0");

  // useEffect(()=>{
  //   if(tokenValue===0) {valueRef.current='0';}  //外部改变tokenValue
  // },[tokenValue])
