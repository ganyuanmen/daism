...
const options = {max: 64,maxSize: 5000,
	...
	dispose: (value, key) => {
	  console.info('delete key:',value,key,new Date().getTime())
	},
	...
	fetchMethod: async (
	  ...
	  { options, signal, context }
		...
		console.info( key,staleValue,options, signal, context)
	},
  }
...
async function accept(postbody,domain,actor) //我关注他人的确认
{
	...
	await saveFollow({actor,user,followId:postbody.object.id})  //关注他人的确认
...
async function verifySignature(req,actor) {
