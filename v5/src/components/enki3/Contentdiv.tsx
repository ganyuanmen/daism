...
import { Down, Noreplay } from "@/lib/jssvg/SvgCollection";
  ...
  return (
    ...
    >
      ...
      >
       ...
       { messageObj.is_discussion===1 ? <MessageReply currentObj={messageObj} isEdit={ableReply()} isTopShow={true} addReplyCallBack={addReplyCallBack} />
       :<span style={{color:'red'}}><Noreplay size={20} /></span>}
