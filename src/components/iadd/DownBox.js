...
const DownBox = forwardRef(({upRef,statusRef,submitRef,user,comulate,utoken,iadd,utokenBalance}, ref) => {
            ...
            <Card.Body style={{backgroundColor:'#F5F6FC'}}>
                ...
                <Row className="align-items-center" >
                    <Col className="Col-auto me-auto" >
                        ...
                        <input readOnly style={{backgroundColor:'transparent',color:'#0D111C', fontSize: '2rem', border: 0,outline:'none',width:'100%',minWidth:'120px'}} 
