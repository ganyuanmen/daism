...
//downRef 输出区域  statusRef 状态区域 submitRef 提交按钮区域
const UpBox = forwardRef(({downRef,statusRef,submitRef,user,gasPrice,priorty,comulate,utoken,iadd,price,ratioRef,utokenBalance}, ref) => {
    ...
    return  <Card className='mb-2 mt-3' >
            <Card.Body style={{backgroundColor:'#F5F6FC'}} >
                ...
                <Row className="align-items-center" >
                    ...
                    <InputBox ref={inputRef}  inobj={inobj} downRef={downRef} statusRef={statusRef} balanceRef={balanceRef} ratioRef={ratioRef}
                        submitRef={submitRef} isallow={isallow} setVita={setVita} user={user} gasPrice={gasPrice} priorty={priorty} comulate={comulate} utoken={utoken} iadd={iadd} price={price} />
                    </Col>
                    <Col className="col-auto" >
                        ...
                        isallow={isallow} setIsallow={setIsallow}  utokenApprove={utokenApprove} tokenApprove={tokenApprove} 

                        ethBalance={ethBalance} utokenBalance={utokenBalance} 
