...
const SubmitButton = forwardRef(({upRef,downRef,statusRef,setUtokenBalance,user,ratioRef}, ref) => {
    ...
    const eth_token = (out_id,value,minRatio) => { 
        showTip(t('walltSubmitText'));
    ...
    const token_token = (in_id,out_id,value,minRatio) => {
        showTip(t('walltSubmitText'));
