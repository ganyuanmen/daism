...
// }
 ...
 export function createWebfinger(userName, domain,dao_id,avatar) {
  return {
    'subject': `acct:${userName}@${domain}`,
    ...
    'links': [
          {
              ...
              "type": "text/html",
              "href": `https://${domain}/communities/visit/${dao_id}`
          },
          {
              'rel': 'self',
              'type': 'application/activity+json',
          ...
          },
          {
              ...
              "href": avatar?`https://${domain}/uploads/${avatar}`:`https://${domain}/logo.svg`
          }
    ]
  };
}
