...
function NewMain({newsData,tc,t}) {
  ...
  async function submit()
  {
    ...
    .then(async response => {
      ...
      router.push(`/info/news/message/${newsData.id}`, { scroll: false }) 
    })
    .catch(error => {
      closeTip()
  ...
  const menu=[
      {url:`/info/visit/${newsData.dao_id}`,title:newsData.dao_name},
      {url:`/info/news/list/${newsData.dao_id}`,title:'news'}
  ]
