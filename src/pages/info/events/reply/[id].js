...
function Message({commontData,replyData,t,tc,statInfo})
{
    ...
    const menu=[
        {url:`/info/visit/${commontData.dao_id}`,title:commontData.dao_name},
        {url:`/info/events/list/${commontData.dao_id}`,title:'events'},
        {url:`/info/events/message/${commontData.pid}`,title:commontData.title},
        {url:`/info/events/discussion/${commontData.pid}`,title:'comments'}
        ]
    ...
    return <>
            <div className='mt-2' >   
                ...
                <Card>
                    <Card.Body>
                    <Link href={`/info/events/discussion/[id]`} as={`/info/events/discussion/${commontData.pid}`} >{t('moreCommont')}...</Link>
                    </Card.Body>
                </Card>
