...
function Message({eventsData,records,t,tc,statInfo})
{
    ...
    return <>
      ...
      <Card>
        <Card.Body>
        <Link href={`/info/events/message/nomenu/[id]`} as={`/info/events/message/nomenu/${eventsData.id}`} >{t('eventsContent')}...</Link>
        </Card.Body>
      </Card>
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                <Col className='Col-auto me-auto' >
                                    <Button size='sm' onClick={e=>{router.push(`/info/events/reply/nomenu/${obj.id}`, { scroll: false })}} variant='light'>{t('searchReply')}</Button>
                                </Col>
