...
function Message({eventsData,records,t,tc,statInfo})
{
  ...
  const menu=[
    ...
    {url:`/info/events/message/${eventsData.id}`,title:eventsData.title}
    ]
    ...
    return <>
      ...
      <Card>
        <Card.Body>
        <Link href={`/info/events/message/[id]`} as={`/info/events/message/${eventsData.id}`} >{t('eventsContent')}...</Link>
        </Card.Body>
      </Card>
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                <Col className='Col-auto me-auto' >
                                    <Button size='sm' onClick={e=>{router.push(`/info/events/reply/${obj.id}`, { scroll: false })}} variant='light'>{t('searchReply')}</Button>
                                </Col>
