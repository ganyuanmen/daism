...
function Message({commontData,replyData,t,tc,statInfo})
{
    ...
    const menu=[
        {url:`/communities/visit/${commontData.dao_id}`,title:commontData.dao_name},
        {url:`/communities/events/list/${commontData.dao_id}`,title:'events'},
        {url:`/communities/events/message/${commontData.pid}`,title:commontData.title},
        {url:`/communities/events/discussion/${commontData.pid}`,title:'comments'}
        ]
    ...
    return <>
            <div className='mt-2' >   
                ...
                <Card>
                    <Card.Body>
                    <Link href={`/communities/events/discussion/[id]`} as={`/communities/events/discussion/${commontData.pid}`} >{t('moreCommont')}...</Link>
                    </Card.Body>
                </Card>
