...
function Message({eventsData,records,t,tc,statInfo})
{
    ...
    return <>
      ...
      <Card>
        <Card.Body>
        <Link href={`/communities/events/message/nomenu/[id]`} as={`/communities/events/message/nomenu/${eventsData.id}`} >{t('eventsContent')}...</Link>
        </Card.Body>
      </Card>
                        ...
                        <Card.Body>
                            ...
                            <Row>
                                <Col className='Col-auto me-auto' >
                                    <Button size='sm' onClick={e=>{router.push(`/communities/events/reply/nomenu/${obj.id}`, { scroll: false })}} variant='light'>{t('searchReply')}</Button>
                                </Col>
