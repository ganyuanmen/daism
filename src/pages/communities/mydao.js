    ...
    const getDaoList=data=>{
        return <Card className='daism-title mt-2'>
                ...
                <Card.Body>
                    ...
                    href={obj.domain?`/${locale}/communities/visit/[id]`:`/${locale}/communities/daoinfo/[id]`} 
                    as={obj.domain?`/${locale}/communities/visit/${obj.dao_id}`:`/${locale}/communities/daoinfo/${obj.dao_id}`}>
