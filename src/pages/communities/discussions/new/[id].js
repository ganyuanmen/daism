...
function NewMain({daoData,user,t,tc}) {
  ...
  async function submit()
  {
    ...
    if(res.status===200)  router.push(`/communities/discussions/message/${res.data}`, { scroll: false })
  ...
  const menu=[
      {url:`/communities/visit/${daoData.dao_id}`,title:daoData.dao_name},
      {url:`/communities/discussions/list/${daoData.dao_id}`,title:'discussions'}
  ]
